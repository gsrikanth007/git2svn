 ...
 * @version    $Id: metadata.php 54 2009-09-28 13:23:49Z seebi $
 */
...
$triplify['namespaces'] = $triplify['namespaces'] + array(
	'prv'=>'http://example.org/provenance/ns#',
	'prvTypes'=>'http://example.org/provenance/types#',
...
class ProvenanceWriter {
	...
	function describeSourceData ( $subject, $tripleizer ) {
		...
		$tripleizer->writeTriple( $doc, $tripleizer->uri('rdf:type'), $tripleizer->uri('prv:Document') );
