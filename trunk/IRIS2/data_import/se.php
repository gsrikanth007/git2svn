<?php
	...
	require_once('./classes/SedDatabaseImport.class.php');
    ...
    // Create new Zend_Db instance
	$objVitoDb = Zend_Db::factory('Pdo_Mysql', array(
		'host'	   => Config::DATABASE_HOST,
		'username' => Config::DATABASE_USER,
		'password' => Config::DATABASE_PASS,
		'dbname'   => 'iris_se',
